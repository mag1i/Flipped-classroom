...
class Homeworkpage extends StatefulWidget {
  ...
  final String StudentName, ln;

  const Homeworkpage({Key key, this.StudentId, this.StudentName, this.ln}) : super(key: key);
...
class _FirstPageState extends State<Homeworkpage> {
   String Name="kjhkj";
    ...
    return Scaffold(
      ...
      body: itemList.length==0?Text("Loading"):ListView.builder(
        ...
        itemBuilder: (context,index){
          ...
          GestureDetector(
                ...
                child: widget.StudentName== itemList[index].studentName? Stack(
                  children: <Widget>[
                    Container(
                      height: 100,
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          print("iiiiiiiiit wooooooorked"+widget.StudentId);
        },
  ...
  void documentFileUpload(String str) {
    var data = {
      ...
      "FileName": Name,
     // "StudentId": widget.StudentId,
      "StudentName": widget.StudentName+" "+widget.ln,
      //store data
    };
