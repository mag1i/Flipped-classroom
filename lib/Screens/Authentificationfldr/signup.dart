            ...
            //    decoration: textInputDecoration.copyWith(hintText: 'email'),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                    hintStyle: TextStyle(fontSize: 17),
                    hintText: 'Year'),
                validator: (val) => val.isEmpty ? 'Enter your current year please' : null,
                onChanged: (val) {
                  setState(() => year = val as int);
                },
              ),
              ...
              RaisedButton(
                  ...
                  onPressed: () async {
                    if(_formKey.currentState.validate()){
                      ...
                      dynamic result = await _auth.registerWithEmailAndPassword(name, ln, email, password,  field, year,bd, _selectedGender,imageUrl   );
